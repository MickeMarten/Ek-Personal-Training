...
function FooterEnd() {
  ...
  <div className="w-full text-white">
    <div className="sm:flex sm:justify-between sm:items-center">
      <a href="/">
        <img src={vitLogga} alt="HE-logo" className="h-16 mb-4 sm:mb-0" />
      </a>
      ...
      <div className="sm:flex gap-12">
        ...
        <div className="mb-6 sm:mb-0">
          ...
          <ul>
            <Footer.Link href="https://example.com" className=" hover:underline">Example Partner 1</Footer.Link>
            <Footer.Link href="https://example.com" className=" hover:underline">Example Partner 2</Footer.Link>
          </ul>
        </div>
      </div>
    </div>
