...
function Cards() {
  ...
  return (
    <section className="py-8 bg-black">
      ...
      <div className="flex flex-row overflow-x-scroll gap-9 p-4 xl:overflow-hidden ">
        {packages.map((pkt) => (
          <Card
            key={pkt.id}
            imgSrc={activeCardId === pkt.id ? undefined : pkt.imagePath}
            className="bg-gray900 flex flex-col justify-between p-6 space-y-4 w-96 mx-auto"
          >
